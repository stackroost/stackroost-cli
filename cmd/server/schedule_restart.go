...
func GetScheduleRestartCmd() *cobra.Command {
	cmd := &cobra.Command{
	...
	cmd.Flags().String("server", "", "Server to restart (apache|nginx|caddy)")
	cmd.Flags().Int("delay", 5, "Delay in seconds before restart")
